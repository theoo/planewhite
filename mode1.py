...
class ScreenSaver(Widget):
  ...
  def __init__(self, **kwargs):
    ...
    # cartel
    self.cartel = Label(text="PlaneWhite", pos=(600,650), font_size=40, color=(1,1,1,1), halign="right")
    self.touch_me = Label(text="try me if you dare!", pos=(600,600), font_size=20, color=(1,1,1,1), halign="right")
